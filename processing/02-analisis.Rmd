...
```{r}
dependencia = round(prop.table(table(categorias=test$dependencia)),2)
dependencia = as.data.frame(dependencia)
dependencia$categorias <- factor(dependencia$categorias, levels = c(1, 2, 3, 4, 5), labels = c("Municipal", "Part. subvencionado","Part. pagado", "Adm. delegada", "Serv. local educación"))
